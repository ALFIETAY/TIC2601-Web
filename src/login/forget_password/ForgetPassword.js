        ...
        <div id='container-pw'>
            ...
            <form className="container-pw" onSubmit={(event)=>updatePw(event,email,newPassword,confirmPassword,navigate)}>
                ...
                <div className="password-pw">
                    ...
                    <input tabIndex={2} type="password" id="password-pw" value={newPassword} onChange={(e) => setNewPassword(e.target.value)}
                    required/>
                </div>
                ...
                <div className="confirm_password-pw">
                    ...
                    <input tabIndex={3} type="password" id="confirm_password-pw"value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}
                    required/>
                </div>
                <div className="empty-pw">
                    <label id="empty-pw">&nbsp</label>
